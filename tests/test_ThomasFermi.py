...
def test_ThomasFermiSolver():
    ...
    for V_Angstrom_cubed, T_keV, PV_over_kTZ, b_ref, beta_boundary_ref in zip(
        Vs_Angstrom_cubed, Ts_keV, PVs_over_kTZ, bs, beta_boundary_vals
    ):
